...
<svg xmlns="http://www.w3.org/2000/svg" width="467" height="150" viewBox="0 0 467 150" fill="none" role="img" aria-labelledby="descId">
        ...
        <desc id="descId">Total Stars Earned: 67280, Total Commits in 2024 : 145, Total Issues: 171</desc>
        <style>
          .header {
    ...
    @keyframes rankAnimation {
      ...
      to {
        stroke-dashoffset: 28.286194705711328;
      }
    }
    ...
    <svg data-testid="icon" class="icon" viewBox="0 0 16 16" version="1.1" width="16" height="16">
      ...
      <text class="stat  bold" x="219.01" y="12.5" data-testid="stars">67.3k</text>
    </g>
    ...
    <svg data-testid="icon" class="icon" viewBox="0 0 16 16" version="1.1" width="16" height="16">
      ...
      <text class="stat  bold" x="219.01" y="12.5" data-testid="issues">171</text>
    </g>
  </g>
    </svg>
